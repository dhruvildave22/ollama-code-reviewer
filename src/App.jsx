...
//     const prompt = `You are a code reviewer. For the following HTML, CSS, or JavaScript code, analyze the customization behavior and respond using this structured format:
...
//             <pre className="whitespace-pre-wrap font-mono text-base text-gray-700 mb-6">{response}</pre>
